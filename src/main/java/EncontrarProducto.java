...
* */
public class EncontrarProducto {

    public static boolean main(Map<String, Object> store, String product){
        ...
        for (Map.Entry<String, Object> entry : store.entrySet()) {
            ...
            if(
                    (isString && entry.getValue().equals(product)) ||
                    (!isString && main((Map<String, Object>) entry.getValue(), product))
            ){
                return true;
            }
        }
